...
public class ObjectExceptionHandler implements IExceptionHandler {
    ...
    public ObjectExceptionHandler(TaskQueue queue, Command command, Exception e, Logger logger) {
        this.queue = queue;
